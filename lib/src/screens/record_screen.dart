...
class _RecordScreenState extends BasePageState {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(S.current.record_title, style: TextStyle(color:HexColor("#030002"), fontSize: 18, fontWeight: FontWeight.w500)),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: [HexColor("#87C100"), HexColor("#B4DB55").withOpacity(0.3)], begin: Alignment.topCenter, end: Alignment.bottomCenter)
            ),
          ),
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Image.asset("assets/images/${item.icon}.png", width: 80, height: 100),
                Container(padding: const EdgeInsets.only(bottom: 11),
                 child: Column(
                  mainAxisAlignment:MainAxisAlignment.end,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    SizedBox(width: 55, child: Text(item.localTitle, style: TextStyle(color: Colors.white.withOpacity(0.7), fontSize: 14, fontWeight: FontWeight.w400))),
                    Text("200", style: TextStyle(color: Colors.white.withOpacity(0.7), fontSize: 16, fontWeight: FontWeight.w500))
                  ],
                ))
              ],
            ),
  ...
  Widget _buildButtonView() {
    ...
    return CupertinoButton(
      ...
      child: Container(
        padding: const EdgeInsets.only(top: 10, left: 48, right: 48, bottom: 10),
